...
class TestCuckooHashTable:
    ...
    def test_cuckoo_stashed_dary_with_random_insertions(self):
        self._test_with_random_insertions(CuckooHashTableStashedDAry())

    def test_cuckoo_stashed_dary_with_random_insertions_then_deletions(self):
        self._test_with_random_insertions_then_deletions(CuckooHashTableStashedDAry())
